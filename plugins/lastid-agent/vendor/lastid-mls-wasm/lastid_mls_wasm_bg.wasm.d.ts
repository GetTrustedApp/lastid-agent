...
export const mlsorchestrator_encryptApplicationMessage: (a: number, b: number, c: number, d: number, e: number) => any;
export const mlsorchestrator_exportGroupInfo: (a: number, b: number, c: number) => any;
export const mlsorchestrator_flushPending: (a: number) => any;
export const mlsorchestrator_forgetGroup: (a: number, b: number, c: number) => any;
export const mlsorchestrator_generateKeyPackage: (a: number) => any;
