 ...
 * @returns {string}
 */
function signParentAuthorization(signing_key_bytes, kid, claims_json) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passArray8ToWasm0(signing_key_bytes, wasm.__wbindgen_malloc);
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.signParentAuthorization(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_isView_a02243d3b11a0508: function(arg0) {
        ...
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("IDBVersionChangeEvent")], shim_idx: 1126, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
